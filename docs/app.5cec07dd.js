...
function (_super) {
  ...
  function CircularDependencyError(m, dependencies) {
    var _this = _super.call(this, m) || this;

    _this.dependencies = dependencies; // Set the prototype explicitly.

    Object.setPrototypeOf(_this, CircularDependencyError.prototype);
    return _this;
  }

  Object.defineProperty(CircularDependencyError.prototype, "circularDependencies", {
    get: function () {
...
var css = ".mst__container,.mst__items{position:relative}.mst__item--rect{position:absolute;z-index:2;cursor:pointer;border:2px solid #000;box-sizing:border-box}.mst__item--rect:hover{border:3px solid #000}.mst__item--completed{position:absolute;opacity:.5;background:#d3d3d3}.mst__time{position:absolute;background:red}.mst__title{padding-left:10px;min-width:400px}.mst__item--rect>.mst__title{margin-top:-1px}.mst__item--diamond{position:absolute;cursor:pointer;z-index:2;line-height:.5;width:0;height:0;border:5px solid transparent;border-bottom-color:#000;top:-5px}.mst__item--diamond:after{content:\"\";position:absolute;left:-5px;top:5px;width:0;height:0;border:5px solid transparent;border-top-color:#000}.mst__item--diamond-attention{position:absolute;cursor:pointer;z-index:2;line-height:.5;width:0;height:0;border:5px solid transparent;border-bottom-color:red;top:-5px}.mst__item--diamond-attention:after{content:\"\";position:absolute;left:-5px;top:5px;width:0;height:0;border:5px solid transparent;border-top-color:red}.mst__item--diamond-completed{position:absolute;cursor:pointer;z-index:2;line-height:.5;width:0;height:0;border:5px solid transparent;border-bottom-color:#d3d3d3;top:-5px}.mst__item--diamond-completed:after{content:\"\";position:absolute;left:-5px;top:5px;width:0;height:0;border:5px solid transparent;border-top-color:#d3d3d3}.mst__time-scale{color:#6b6b6b;font-size:12px;border-bottom:1px solid #cecece;background-color:#fff;box-sizing:border-box;margin:0;padding:0;position:relative}.mst__time-scale-text{position:absolute;color:#a6a6a6;display:inline-block;white-space:nowrap;overflow:hidden;text-align:center;height:100%}.mst__time-scale-marker{position:absolute;top:22px;width:1px;height:10px;color:#a6a6a6;background:#a6a6a6}.mst__time-scale-legend{text-align:right;padding-top:16px;font-size:.8rem}.mst__item,.mst__link,.mst__links{position:absolute}.mst__link--vertical{background:#a6a6a6;opacity:.5;height:0;width:2px}.mst__link--horizontal{background:#a6a6a6;opacity:.5;width:0;height:2px}.mst__link:hover>.mst__link--vertical{width:3px}.mst__link:hover>.mst__link--horizontal{height:3px}.mst__arrow{position:absolute;width:0;height:0;border-style:solid}.mst__arrow.mst__arrow--right{border-width:6px 0 6px 6px;border-color:transparent transparent transparent #cecece}.mst__arrow.mst__arrow--left{border-width:6px 6px 6px 0;border-color:transparent #cecece transparent transparent}.mst__tooltip{position:relative;display:inline-block;border-bottom:1px dotted #000}.mst__tooltip .mst__tooltiptext{visibility:hidden;line-height:1;width:200px;bottom:150%;left:50%;margin-left:-100px;background-color:#000;color:#fff;text-align:center;border-radius:6px;padding:5px 0;position:absolute;z-index:1}.mst__tooltip .mst__tooltiptext:after{content:\" \";position:absolute;top:100%;left:50%;margin-left:-5px;border:5px solid transparent;border-top-color:#000}.mst__tooltip:hover .mst__tooltiptext{visibility:visible}";
styleInject(css);
/**
...
var calcStartEndTimes = function (items) {
  ...
  var resolvable = function (deps) {
    return deps.reduce(function (acc, cur) {
      return acc && lookupMap.hasOwnProperty(cur.id) && (cur.condition === 'started' ? lookupMap[cur.id].hasStartTime : lookupMap[cur.id].hasEndTime);
    }, true);
  ...
  var _loop_1 = function () {
    ...
    if (!hasChanged && keys.length) {
      ...
      throw new CircularDependencyError('Cannot resolve circular dependencies', keys.reduce(function (acc, key) {
  ...
  return items.reduce(function (acc, item, row) {
    if (item.dependsOn && item.dependsOn.length) {
      var links = item.dependsOn.map(function (dep) {
        ...
        var it = found.it,
            index = found.index;
        var hasStartCondition = dep.condition === 'started';
        ...
        return {
          ...
          x2: x2,
          y2: y2,
          indicator: it.children ? 'none' : hasStartCondition ? 'start' : 'end'
        };
      }).filter(Boolean);
...
var ScenarioItem = function () {
  var isInstantaneous = function (item) {
    return (!item.children || item.children.length === 0) && item.endTime === item.startTime;
  };
  ...
  return {
    view: function (_a) {
      ...
      return (0, _mithril.default)('.mst__item', isInstantaneous(item) ? (0, _mithril.default)(item.highlight ? '.mst__item--diamond-attention' : item.completed === 1 ? '.mst__item--diamond-completed' : '.mst__item--diamond', {
        ...
        onclick: onclick
      }, (0, _mithril.default)('.mst__title', titleView ? (0, _mithril.default)(titleView, {
        item: item
      }) : item.title)) : (0, _mithril.default)('.mst__item--rect', {
...
var TimeAxis = function () {
  ...
  var stepSize = function (s, e) {
    var duration = e - s;
    return duration <= 10 ? 1 : duration <= 30 ? 5 : duration <= 60 ? 10 : duration <= 300 ? 30 : duration <= 600 ? 60 : duration <= 900 ? 120 : duration <= 1800 ? 300 : duration <= 3600 ? 600 : duration <= 7200 ? 900 : duration <= 14400 ? 1800 : 3600;
  };

  var scaleFactor = function (step) {
  ...
  var formatRealTime = function (time, sf) {
    return padLeft(time.getHours()) + ":" + padLeft(time.getMinutes()) + (sf === 1 ? "." + padLeft(time.getSeconds()) : '');
  };
...
var ScenarioLink = function () {
  ...
  var indLine = function (_a) {
    var indicator = _a.indicator;
    return "left: " + (indicator === 'start' ? 0 : -4) + "px; top: 0px;";
  };
  ...
  return {
    view: function (_a) {
      ...
      return (0, _mithril.default)('.mst__link', {
        ...
        style: verLine(link)
      }), indicator === 'none' ? undefined : (0, _mithril.default)('.mst__arrow', {
        style: indLine(link),
...
exports.HomePage = function () {
  return {
    view: function view() {
      return mithril_1.default('.row', [mithril_1.default('.col.s12.m7.l8', mithril_1.default('.introduction', [mithril_1.default('h2', 'About mithril-scenario-timeline'), mithril_1.default('p', ["A component for Mithril to create a scenario timeline. See the ", mithril_1.default('a[href=/editor]', {
        oncreate: mithril_1.default.route.link
